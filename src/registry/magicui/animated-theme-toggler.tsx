...
export const AnimatedThemeToggler = ({
  ...
  return (
    <button
      ...
      onClick={toggleTheme}
      className={cn(
        "inline-flex items-center justify-center rounded-xl p-2 text-sm font-medium transition-colors hover:bg-surface-subtle hover:text-text-main focus-ring shrink-0 [&_svg]:w-4 [&_svg]:h-4",
        className
      )}
      {...props}
    >
