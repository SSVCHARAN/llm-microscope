...
export function GeneratedTextView({
  ...
  return (
    <div className="bg-surface border border-border rounded-2xl p-4 sm:p-4.5 flex flex-col shadow-sm dark:shadow-xl relative font-sans">
      {/* Header */}
      <div className="flex flex-col mb-2 gap-1 border-b border-border-subtle pb-2">
        ...
        {showTokenBoundaries && (
          <div className="text-[10px] font-mono text-primary-600 dark:text-emerald-400 leading-tight">
      ...
      <div
        ...
        className="h-28 sm:h-32 bg-surface-raised border border-border rounded-xl p-3 overflow-y-auto font-mono text-sm leading-relaxed whitespace-pre-wrap relative shadow-inner scrollbar-hide text-text-main"
      >
        {steps.map((step) => (
          <TokenButton
            key={step.index}
